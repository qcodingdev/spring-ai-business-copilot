...
const live = {
  ...
  checks: [
    ...
    { checkId: 'DATA_EXPIRED_RESULTS', module: 'DATA' as const, status: 'PASS' as const, affectedCount: 0, threshold: 'PT15M', actionPath: '/data?tab=records' },
  ],
...
describe('EnterpriseReadinessPanel', () => {
  ...
  it('keeps immutable history visible when the live probe fails closed', async () => {
