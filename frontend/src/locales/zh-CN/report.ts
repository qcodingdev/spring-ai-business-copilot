export default {
  ...
  recordsDescription: '查看当前账号创建的报告草稿、状态和确认后的办公格式导出。', schedulesDescription: '保存周期任务并查看下一次运行时间；任务只生成待人工确认草稿。', createdAt: '创建时间', createSchedule: '新建报告排期', scheduleKey: '排期标识', scheduleTitle: '报告标题模板', reportType: '报告类型', cronExpression: 'Cron 表达式', zoneId: '时区', scheduleHint: '例如每周一 09:00：0 0 9 ? * MON。排期仅接受可重复读取的外部连接或客服指标，不接受一次性 Data 交接；生成后仍需人工复核确认。', nextRun: '下次运行', lastRun: '上次运行', scheduleSaved: '报告排期已保存。', openReview: '打开并继续复核', connectionIds: '外部连接编号（逗号分隔）', handoffReferences: 'Data 交接引用（仅即时生成）', previousHandoffReference: '对比期 Data 交接引用（仅即时生成）', includeSupportMetrics: '纳入客服质量指标', viewRuns: '查看运行记录', failureReason: '失败原因',
  ...
  generate: '生成报告草稿',
  confirmReport: '确认报告',
  reviewOpened: '报告复核会话已打开，确认凭证已安全轮换。',
