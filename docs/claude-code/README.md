...
2. 再按顺序执行 [v1-module-prompts.md](v1-module-prompts.md) 中的模块 prompt。
3. 每完成一个阶段，用 [v1-review-checklist.md](v1-review-checklist.md) 做自检。
4. 交给 Codex review 时，以本目录文档和 `AGENTS.md` 为评审基准。
