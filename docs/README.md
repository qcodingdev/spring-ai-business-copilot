# Spring AI Business Copilot 工程文档

本目录保存版本化的规划、架构决策、模块说明和运行文档；面向普通使用者的公开入口仍以根目录和各 Maven Module 的 `README.md` 为准。
...
| 运行、容量与恢复 | [operations-runbook.md](operations-runbook.md) |
