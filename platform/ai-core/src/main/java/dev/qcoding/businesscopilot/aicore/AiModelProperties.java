 ...
 * @param providerName        stable provider/adapter name recorded in audit logs
...
public record AiModelProperties(
    ...
    public AiModelProperties(String modelName, boolean modelDisabled, int maxPromptInputChars) {
        this(modelName, "openai-compatible", modelDisabled, maxPromptInputChars);
    }
